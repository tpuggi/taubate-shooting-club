  ...
  return (
    <div className="text-white mt-28" data-aos="fade-up">
      ...
      <div className="grid grid-cols-2 gap-3">
        <div
          className="h-auto max-h-[20rem] w-auto flex items-center m-12 bg-white border border-gray-200 rounded-lg shadow  bg-gradient-to-b from-neutral-700 to-neutral-900"
          data-aos="flip-right"
        >
